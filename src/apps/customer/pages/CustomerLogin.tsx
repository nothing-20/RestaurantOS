            ...
            {errorState.showRegister && (
              <div className="pt-2 border-t border-red-900/20 flex justify-end">
                <Button 
                  ...
                  className="bg-red-500 hover:bg-red-650 text-slate-950 text-[10px] py-1 px-3 font-bold"
                >
                  Register Account
                </Button>
              </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex justify-between items-center text-xs pt-1">
            <label className="flex items-center space-x-2 text-slate-400 font-semibold cursor-pointer">
              <input type="checkbox" className="rounded bg-slate-950 border-slate-800 focus:ring-primary text-primary" />
