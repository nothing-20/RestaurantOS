...
export const RestaurantDetails: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 pb-16 text-left relative overflow-hidden select-none">
      ...
      <div className="w-full h-64 relative bg-slate-955 bg-slate-950">
        <img src={rCover} alt={rName} className="w-full h-full object-cover" />
        <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/40 to-transparent" />
        
        <button
          onClick={() => navigate('/customer/restaurants')}
          className="absolute top-6 left-6 p-2.5 bg-slate-900/80 hover:bg-slate-800 border border-slate-755 text-slate-350 hover:text-textPearl rounded-2xl transition-all backdrop-blur-md"
        >
        ...
        <Card className="p-8 border-slate-850 bg-slate-900/60 backdrop-blur-md rounded-3xl space-y-6 shadow-2xl">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center space-x-4">
              <div className="w-16 h-16 rounded-2xl border border-slate-805 bg-slate-900 overflow-hidden shrink-0 flex items-center justify-center shadow-lg">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="bg-slate-950 border border-slate-800 px-3.5 py-1.5 rounded-xl text-xs font-bold text-slate-355 flex items-center space-x-1.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
            <button
              ...
              className="p-5 border border-slate-800 hover:border-primary bg-slate-955 bg-slate-950/45 hover:bg-slate-900/40 text-slate-350 hover:text-primary rounded-2xl flex flex-col items-center gap-3.5 transition-all duration-300 group shadow-lg"
            >
            ...
            {tables.length === 0 ? (
              ...
              tables.map((t) => {
                ...
                return (
                  ...
                  >
                    <Table className={`w-5 h-5 ${isOccupied ? 'text-slate-600' : 'text-primary'}`} />
