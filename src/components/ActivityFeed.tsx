          ...
          {filteredEvents.map(event => (
            ...
            >
              <div className="flex-1 space-y-1">
                ...
                <p className="text-slate-350 font-semibold">{event.description}</p>
              ...
              {event.metadata && Object.keys(event.metadata).length > 0 && (
                <div className="bg-slate-950/40 p-2.5 border border-slate-850 rounded-xl text-[9.5px] font-mono text-slate-450 max-w-xs overflow-hidden shrink-0 text-left">
