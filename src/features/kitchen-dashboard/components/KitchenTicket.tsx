...
import { IKdsOrder, TPriority } from '../types';
import {
  getElapsedSeconds,
...
export const STATUS_CONFIG: Record<string, { label: string; color: string; dot: string }> = {
  ...
  ARCHIVED:  { label: 'Archived',  color: 'border-slate-800 bg-slate-950/20 text-slate-600',      dot: 'bg-slate-700' },
};
    ...
    >
      ...
      <div className="p-4 pb-3 border-b border-current border-opacity-10">
        <div className="flex items-start justify-between gap-1.5">
          {/* Left: Select checkbox + table info */}
          <div className="flex items-start space-x-2.5">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                {/* Priority Selector with override support */}
                <select
                  value={priority}
                  onChange={(e) => {
                    e.stopPropagation();
      ...
      <div className="px-4 pb-4">
        {order.status === 'PREPARING' ? (
          ...
          <div className="flex flex-col gap-2">
            <div className="bg-orange-950/20 border border-orange-500/20 text-orange-400 rounded-xl p-2.5 text-[10px] italic">
