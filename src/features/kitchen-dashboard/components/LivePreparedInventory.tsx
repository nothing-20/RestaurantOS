            ...
            return (
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  {available <= threshold && (
                    <div className="bg-amber-500/10 border border-amber-500/20 text-yellow-455 p-2 rounded-xl text-[10px] font-extrabold text-center flex items-center justify-center space-x-1.5 uppercase tracking-wider animate-pulse">
                  ...
                  <div className="bg-slate-955/50 border border-slate-850/60 rounded-xl p-2.5 space-y-1.5 text-[10px] text-left">
                      ...
                      <div className="flex space-x-1">
                        {[5, 10].map(amt => (
                          <button
                            ...
                            className="flex-1 py-1 rounded bg-slate-955 hover:bg-slate-900 border border-slate-800 text-[10px] font-bold text-primary flex items-center justify-center space-x-0.5"
                          >
                      ...
                      <div className="flex space-x-1">
                        {[1, 5].map(amt => (
                          <button
                            ...
                            className="flex-1 py-1 rounded bg-slate-955 hover:bg-slate-900 border border-slate-800 text-[10px] font-bold text-slate-400 flex items-center justify-center space-x-0.5"
                          >
          ...
          <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-4 gap-2">
              ...
              <button
                ...
                disabled={isSubmitting}
                className="py-1.5 text-xs font-bold rounded-xl border bg-slate-955 border-slate-855 text-slate-455 hover:text-textPearl"
              >
                Default
              </button>
            </div>
